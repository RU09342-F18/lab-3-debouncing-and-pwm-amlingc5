...
void LEDSetup(void)                                   // Setup for LEDs (P1.0 and P2.0)
{
...
void ButtonSetup(void)                                // Setup for Button (P1.1)
{
...
void TimerB0Setup(void)                               // Setup for Timer B0 (Debouncing)
{
...
void TimerB1Setup(void)                               // Setup for Timer B1 (Duty Cycle)
{
...
#pragma vector = TIMER0_B0_VECTOR                     // Interrupt service routine for TimerB0
