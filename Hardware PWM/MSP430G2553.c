...
void LEDSetup(void)                             // Setup for LEDs (P1.0 and P1.6)
{
...
void ButtonSetup(void)                          // Setup for Button (P1.3)
{
...
void TimerA0Setup(void)                         // Setup for Timer A0 (Duty Cycle)
{
...
void TimerA1Setup(void)                         // Setup for Timer A1 (Debouncing)
{
...
#pragma vector = TIMER1_A0_VECTOR               // Interrupt service routine for TimerA0
