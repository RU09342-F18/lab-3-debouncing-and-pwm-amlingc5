...
void LEDSetup(void)                           // Configure LEDs
{
...
void TimerA0Setup(void)                       // Configure Timer A0 (Duty Cycle)
{
...
void TimerA1Setup(void)                       // Configure Timer A1 (Debounce)
{
...
#pragma vector=PORT1_VECTOR                   // Interrupt service routine for Port 1 (Button)
...
#pragma vector=TIMER1_A0_VECTOR               // Interrupt routine for Timer A0
...
#pragma vector=TIMER0_A1_VECTOR               // Interrupt routine for Timer A1
...
#pragma vector=TIMER0_A0_VECTOR               // Interrupt routine for Timer A0
